...
>(({ className, ...props }, ref) => {
  ...
  const destructiveGroupClasses =
    "group-[.destructive]:border-muted/40 group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive";
  const actionMerged = cn(
    baseActionClasses,
    destructiveGroupClasses,
    className
  );

  return (
    <ToastPrimitives.Action ref={ref} className={actionMerged} {...props} />
  );
});
...
>(({ className, ...props }, ref) => {
  const baseCloseClasses =
    "absolute right-1 top-1 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100";
  const destructiveCloseClasses =
    "group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600";
  const closeMerged = cn(baseCloseClasses, destructiveCloseClasses, className);
